...
pd = os.path.abspath(os.path.join(os.path.abspath(os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.path.pardir)), os.path.pardir)), os.path.pardir))
print(pd)
sys.path.append(pd)
...
def parse_args(args, parser):
    ...
    parser.add_argument("--num_in_group", type=int, default=2,
                        help="number of controlled players in a group.")
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.football_runner_SAEIR import FootballRunner as Runner
    else:
        pass
